...
new Vue({
	...
	computed: {
		...
		sortedTeams: function() {
			return _.orderBy(this.teams, this.orderBy, this.orderOption);
		}
	},
	filters: {
...
let data = {
  "standing": [
    ...
    }, 
    {
      ...
      "goals": 34, 
      "crestURI": "https://upload.wikimedia.org/wikipedia/en/f/fd/Brighton_&_Hove_Albion_logo.svg", 
      "position": 15, 
      "goalDifference": -20, 
      "goalsAgainst": 54
    }, 
    {
      ...
      "goals": 28, 
      "crestURI": "https://upload.wikimedia.org/wikipedia/en/5/5a/Huddersfield_Town_A.F.C._logo.svg", 
      "position": 16, 
      "goalDifference": -30, 
      "goalsAgainst": 58
    }, 
  ...
  "_links": {
    "self": {
      "href": "http://api.football-data.org/v1/competitions/445/leagueTable/?matchday=38"
    }, 
    "competition": {
